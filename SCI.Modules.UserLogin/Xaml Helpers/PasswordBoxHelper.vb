...
Namespace SCI.Modules.UserLogin.XamlHelpers

    Public Class PasswordBoxHelper

        Public Shared ReadOnly BoundPassword As DependencyProperty =
        ...
        Public Shared ReadOnly BindPassword As DependencyProperty =
        ...
        Private Shared ReadOnly UpdatingPassword As DependencyProperty =
